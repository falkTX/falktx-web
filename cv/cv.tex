...
\aboutme{About Me}{\\
Self-taught software developer, with personal interest in C and C++.\\
...
\bluebullet Docker & \bluebullet POSIX/macOS/win32 APIs\\
\end{tabular}}
...
% 	  Desktop tools and Debian-based repositories, focused on audio production.\vspace{0.04cm}
	...
	\item \textbf{Carla} - \textit{kx.studio/carla} - 2011\\
	  ...
	  Loads several formats and also works as an audio plugin itself.\vspace{0.04cm}
...
\CVItem{March 2024 - Current, \textit{Linux Developer}, Darkglass Electronics Oy}{
\begin{itemize}
	\item Creation of a highly-optimized, real-time Linux embedded system with graphics
	\item Linux kernel driver development
	\item Overseeing and guiding team towards a Linux-based OS
	\item Programming of complex UI + state + audio architecture
\end{itemize}
Technologies used: Buildroot, C, C++, Linux kernel, LVGL
}

%------------------------------------------------

\CVItem{September 2015 - September 2017, May 2019 - February 2024, \textit{Lead Software Developer}, MOD Devices GmbH / MOD Audio UG}{
\begin{itemize}
...
\CVItem{2023, \textit{\small{Making a Standalone FX Pedal Based on Embed Linux}\normalsize}, \small{Ubuntu Summit}\normalsize}{
 https://www.youtube.com/watch?v=PpBKwD5PSFs
\vspace{0.3691cm}
}
...
\CVItem{2018, \textit{Carla feature overview and workflows}, Linux Audio Conference}{
 \small{https://media.ccc.de/v/lac2018-24-carla\_plugin\_host\_feature\_overview\_and\_workflows}\normalsize
\vspace{0.0cm}
}
