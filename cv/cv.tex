...
\begin{itemize}
	\item \textbf{KXStudio} - \textit{kx.studio} - 2009\\
	  Linux distribution and repositories, focused on audio production.\vspace{0.04cm}

	\item \textbf{Cadence} - \textit{kx.studio/cadence} - 2009\\
	  A collection of tools to manage Linux audio.\\
	  Includes JACK settings, patchbay, recorder, meter and more.\vspace{0.04cm}
...
\CVItem{May 2019 - current, \textit{Software Developer}, MOD Devices GmbH}{
\begin{itemize}
	\item Linux embed developer and tech lead
\end{itemize}
