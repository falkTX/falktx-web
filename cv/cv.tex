...
{\begin{tabular}{p{0.15\textwidth} p{0.15\textwidth} p{0.15\textwidth} p{0.15\textwidth}}
\bluebullet Juce & \bluebullet Qt & \bluebullet HTML5/CSS/JavaScript\\
\end{tabular}}
...
\begin{itemize}
	\item \textbf{KXStudio} - \textit{kxstudio.linuxaudio.org} - 2009\\
	...
	\item \textbf{Cadence} - \textit{kxstudio.linuxaudio.org/cadence} - 2009\\
	  A collection of tools to manage Linux audio.\\
	  Includes Audio settings, patchbay, recorder, meter and logs viewer.\vspace{0.04cm}

	\item \textbf{Carla} - \textit{kxstudio.linuxaudio.org/carla} - 2011\\
	  Fully-featured cross-platform audio plugin host.\\
	  Loads plugins (LADSPA, DSSI, LV2, VST, AU) and sample banks (GIG, SF2, SFZ), and also works as an audio plugin itself.\vspace{0.04cm}
...
\CVItem{September 2017 - current, \textit{Software Developer}, Snuk}{
\begin{itemize}
	\item Full-stack developer
\end{itemize}
Technologies used: Go, Grafana, Ansible, Docker
}
...
\end{itemize}
Technologies used: HTML5, Javascript, Python, C, C++, Buildroot
}
...
\CVItem{2015, \textit{Carla Presentation}, Linux Audio Conference}{
 http://lac.linuxaudio.org/2015/video.php?id=47\&h=576
\vspace{0.25cm}
}

\CVItem{2015, \textit{Testing audio plugins with Carla}, Linux Audio Conference}{
 http://lac.linuxaudio.org/2015/video.php?id=70\&h=576
\vspace{0.25cm}
}

\CVItem{2015, \textit{Personal Interview}, Libre Music Production}{
 http://libremusicproduction.com/articles/friday-interview-2-falktx
\vspace{0.25cm}
}
...
\CVItem{2014, \textit{DPF Presentation}, Linux Audio Conference}{
 http://lac.linuxaudio.org/2014/video.php?id=91\&h=720
\vspace{0.25cm}
}
